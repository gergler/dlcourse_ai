...
class ConvNet:
    ...
    def compute_loss_and_gradients(self, X, y):
        ...
        loss, d_out = softmax_with_cross_entropy(pred, y)
    ...
    def params(self):
        result = {'W1': self.conv_1.params()['W'], 
                  'B1': self.conv_1.params()['B'], 
                  'W2': self.conv_2.params()['W'], 
                  'B2': self.conv_2.params()['B'], 
                  'W3': self.fc.params()['W'], 
                  'B3': self.fc.params()['B']}
